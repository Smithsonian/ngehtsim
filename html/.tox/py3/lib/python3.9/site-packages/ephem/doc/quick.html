...
<head>
  ...
  <title>PyEphem Quick Reference &mdash; ngehtsim 0+untagged.135.gd18facc.dirty documentation</title>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/source/api.html">API</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>PyEphem Quick Reference</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../../_sources/.tox/py3/lib/python3.9/site-packages/ephem/doc/quick.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
  ...
  <section id="pyephem-quick-reference">
<h1>PyEphem Quick Reference<a class="headerlink" href="#pyephem-quick-reference" title="Permalink to this heading"></a></h1>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">ephem</span> <span class="kn">import</span> <span class="o">*</span>
...
<section id="bodies">
<h2>Bodies<a class="headerlink" href="#bodies" title="Permalink to this heading"></a></h2>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">m</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Mars</span><span class="p">()</span>
...
<ul class="simple">
<li><p>The Sun, Moon, planets, and major planet moons each have their own class.</p></li>
<li><p>PyEphem includes a modest catalog of famous bright stars.</p></li>
<li><p>Body instances know their <code class="docutils literal notranslate"><span class="pre">name</span></code>
(which you can set to whatever you want).</p></li>
</ul>
</div></blockquote>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">m</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Mars</span><span class="p">(</span><span class="s1">&#39;2003/8/27&#39;</span><span class="p">)</span>
...
<ul class="simple">
<li><p>Extra arguments when you create a Body
...
<section id="body-compute-date">
<h3>body.compute(date)<a class="headerlink" href="#body-compute-date" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">j</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Jupiter</span><span class="p">()</span>
...
<ul>
<li><p>Computes the position of the <code class="docutils literal notranslate"><span class="pre">body</span></code>.</p></li>
<li><p>The date if omitted defaults to <code class="docutils literal notranslate"><span class="pre">now()</span></code>.</p></li>
<li><p>The epoch if omitted defaults to <code class="docutils literal notranslate"><span class="pre">'2000'</span></code>.</p></li>
<li><p>Date and epoch arguments can be anything acceptable to <code class="docutils literal notranslate"><span class="pre">Date()</span></code>.</p></li>
<li><p>Sets the following <code class="docutils literal notranslate"><span class="pre">body</span></code> attributes:</p>
...
<li><p>On Solar System bodies, also sets:</p>
<div class="line-block">
...
<li><p>On planetary moons, also sets:</p>
<div class="line-block">
...
<li><p>On artificial satellites, also sets:</p>
<div class="line-block">
...
<li><p>On <code class="docutils literal notranslate"><span class="pre">Moon</span></code> bodies, also sets:</p>
<div class="line-block">
...
<li><p>On <code class="docutils literal notranslate"><span class="pre">Jupiter</span></code> bodies,
...
<li><p>On <code class="docutils literal notranslate"><span class="pre">Saturn</span></code> bodies,
...
<section id="body-compute-observer">
<h3>body.compute(observer)<a class="headerlink" href="#body-compute-observer" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">gatech</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Observer</span><span class="p">()</span>
...
<ul>
<li><p>Computes the position of the <code class="docutils literal notranslate"><span class="pre">Body</span></code>.</p></li>
<li><p>Uses the <code class="docutils literal notranslate"><span class="pre">date</span></code> of the observer.</p></li>
<li><p>Uses the <code class="docutils literal notranslate"><span class="pre">epoch</span></code> of the observer.</p></li>
<li><p>Sets all of the <code class="docutils literal notranslate"><span class="pre">Body</span></code> attributes listed in the previous section.</p></li>
<li><p>For earth satellite objects,
...
instead of geocentric.</p></li>
<li><p>Also computes where the body appears in the sky
...
set the observer’s <code class="docutils literal notranslate"><span class="pre">pressure</span></code> to zero to ignore refraction.</p></li>
<li><p>If you are curious about how big an effect
...
but also its apparent <code class="docutils literal notranslate"><span class="pre">.ra</span></code> and <code class="docutils literal notranslate"><span class="pre">.dec</span></code>.</p></li>
</ul>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">alt</span><span class="p">)</span>
...
<ul class="simple">
<li><p>But if you simply want to perform a quick check
...
The effect of refraction will only be large near the horizon.</p></li>
</ul>
</div></blockquote>
</section>
<section id="catalog-format">
<h3>catalog format<a class="headerlink" href="#catalog-format" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">line</span> <span class="o">=</span> <span class="s2">&quot;C/2002 Y1 (Juels-Holvorcem),e,103.7816,166.2194,128.8232,242.5695,0.0002609,0.99705756,0.0000,04/13.2508/2003,2000,g  6.5,4.0&quot;</span>
...
<ul>
<li><p>Bodies can be imported and exported
in the popular <a class="reference external" href="http://www.clearskyinstitute.com/xephem/help/xephem.html#mozTocId468501">XEphem format</a>.</p></li>
<li><p>When you deal with asteroids and comets,
whose orbital parameters are subject to frequent revision,
you will usually find yourself downloading an XEphem file
and reading its contents.</p></li>
<li><p>To interpret a line in XEphem format,
...
<li><p>To export a body in XEphem format,
...
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">line1</span> <span class="o">=</span> <span class="s2">&quot;ISS (ZARYA)&quot;</span>
...
<ul class="simple">
<li><p>Satellite elements often come packaged in a format called TLE,
that has the satellite name on one line
and the elements on the following two lines.</p></li>
<li><p>Call the <code class="docutils literal notranslate"><span class="pre">readtle()</span></code> function to turn a TLE entry
into a PyEphem <code class="docutils literal notranslate"><span class="pre">Body</span></code>.</p></li>
</ul>
</div></blockquote>
</section>
<section id="bodies-with-orbital-elements">
<h3>bodies with orbital elements<a class="headerlink" href="#bodies-with-orbital-elements" title="Permalink to this heading"></a></h3>
<blockquote>
<div><ul>
<li><p>When you load minor objects like comets and asteroids,
the resulting object specifies the <em>orbital elements</em>
that allow XEphem to predict its position.</p></li>
<li><p>These orbital elements are available for you to inspect and change.</p></li>
<li><p>If you lack a catalog from which to load an object,
you can start by creating a raw body of one of the following types
and filling in its elements.</p></li>
<li><p>Element attribute names start with underscores
to distinguish them from the normal <code class="docutils literal notranslate"><span class="pre">Body</span></code> attributes
that are set as the result of calling <code class="docutils literal notranslate"><span class="pre">compute()</span></code>.</p></li>
<li><p>Each <code class="docutils literal notranslate"><span class="pre">FixedBody</span></code> has only three necessary elements:</p>
<div class="line-block">
...
<li><p><code class="docutils literal notranslate"><span class="pre">EllipticalBody</span></code> elements:</p>
<div class="line-block">
...
<li><p><code class="docutils literal notranslate"><span class="pre">HyperbolicBody</span></code> elements:</p>
<div class="line-block">
...
<li><p><code class="docutils literal notranslate"><span class="pre">ParabolicBody</span></code> elements:</p>
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">_epoch</span></code> — Epoch for <code class="docutils literal notranslate"><span class="pre">_inc</span></code>, <code class="docutils literal notranslate"><span class="pre">_Om</span></code>, and <code class="docutils literal notranslate"><span class="pre">_om</span></code></div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_epoch_p</span></code> — Epoch of perihelion</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_inc</span></code> — Inclination (°)</div>
...
<li><p><code class="docutils literal notranslate"><span class="pre">EarthSatellite</span></code> elements of man-made satellites:</p>
<div class="line-block">
...
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">m</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Moon</span><span class="p">(</span><span class="s1">&#39;1980/6/1&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">ephem</span><span class="o">.</span><span class="n">constellation</span><span class="p">(</span><span class="n">m</span><span class="p">))</span>
<span class="go">(&#39;Sgr&#39;, &#39;Sagittarius&#39;)</span>
</pre></div>
</div>
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">constellation()</span></code> function returns a tuple
containing the abbreviated name and full name
of the constellation in which its argument lies.</p></li>
<li><p>You can either pass a <code class="docutils literal notranslate"><span class="pre">Body</span></code> whose position is computed,
...
specifying another value.</p></li>
</ul>
</div></blockquote>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">ephem</span><span class="o">.</span><span class="n">delta_t</span><span class="p">(</span><span class="s1">&#39;1980&#39;</span><span class="p">))</span>
<span class="go">50.54</span>
</pre></div>
</div>
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">delta_t()</span></code> function
returns the difference, in seconds, on the given date
between Terrestrial Time and Universal Time.</p></li>
<li><p>Takes a <code class="docutils literal notranslate"><span class="pre">Date</span></code> or <code class="docutils literal notranslate"><span class="pre">Observer</span></code> argument.</p></li>
<li><p>Without an argument, uses <code class="docutils literal notranslate"><span class="pre">now()</span></code>.</p></li>
</ul>
</div></blockquote>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">ephem</span><span class="o">.</span><span class="n">julian_date</span><span class="p">(</span><span class="s1">&#39;2000/1/1&#39;</span><span class="p">)</span>
<span class="go">2451544.5</span>
</pre></div>
</div>
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">julian_date()</span></code> function
returns the official Julian Date of the given day and time.</p></li>
<li><p>Takes a <code class="docutils literal notranslate"><span class="pre">Date</span></code> or <code class="docutils literal notranslate"><span class="pre">Observer</span></code> argument.</p></li>
<li><p>Without an argument, uses <code class="docutils literal notranslate"><span class="pre">now()</span></code>.</p></li>
</ul>
</div></blockquote>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">ra</span><span class="p">,</span> <span class="n">dec</span> <span class="o">=</span> <span class="s1">&#39;7:16:00&#39;</span><span class="p">,</span> <span class="s1">&#39;-6:17:00&#39;</span>
...
<ul>
<li><p>Take an <code class="docutils literal notranslate"><span class="pre">ra</span></code> and <code class="docutils literal notranslate"><span class="pre">dec</span></code> as arguments.</p></li>
<li><p>Return the volume and page on which that coordinate lies
...
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">m1</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Moon</span><span class="p">(</span><span class="s1">&#39;1970/1/16&#39;</span><span class="p">)</span>
...
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">separation()</span></code> function
returns the angle that separates two positions on a sphere.</p></li>
<li><p>Each argument can be either a <code class="docutils literal notranslate"><span class="pre">Body</span></code>,
...
and <code class="docutils literal notranslate"><span class="pre">lat</span></code> measures the angle above or below its equator.</p></li>
</ul>
</div></blockquote>
</section>
<hr class="docutils" />
...
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">np</span> <span class="o">=</span> <span class="n">Equatorial</span><span class="p">(</span><span class="s1">&#39;0&#39;</span><span class="p">,</span> <span class="s1">&#39;90&#39;</span><span class="p">,</span> <span class="n">epoch</span><span class="o">=</span><span class="s1">&#39;2000&#39;</span><span class="p">)</span>
...
<ul>
<li><p>There are three coordinate classes,
...
<li><p>When creating a new coordinate,
you can pass either a body,
or another coordinate,
or a pair of raw angles
(always place the longitude or right ascension first).</p></li>
<li><p>When creating a coordinate,
...
or J2000 is used as the default.</p></li>
<li><p>See the <a class="reference external" href="coordinates">Coordinate Transformations</a> document for more details.</p></li>
</ul>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">lowell</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Observer</span><span class="p">()</span>
...
<ul>
<li><p>Describes a position on Earth’s surface.</p></li>
<li><p>Pass to the <code class="docutils literal notranslate"><span class="pre">compute()</span></code> method of a <code class="docutils literal notranslate"><span class="pre">Body</span></code>.</p></li>
<li><p>These are the attributes you can set:</p>
<div class="line-block">
...
<li><p>The <code class="docutils literal notranslate"><span class="pre">date</span></code> defaults to <code class="docutils literal notranslate"><span class="pre">now()</span></code>.</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">epoch</span></code> defaults to <code class="docutils literal notranslate"><span class="pre">'2000'</span></code>.</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">temperature</span></code> defaults to 25°C.</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">pressure</span></code> defaults to 1010mBar.</p></li>
<li><p>Other attributes default to zero.</p></li>
<li><p>You can also refer to temperature by its old name <code class="docutils literal notranslate"><span class="pre">temp</span></code>.</p></li>
<li><p>You can make a copy of an <code class="docutils literal notranslate"><span class="pre">Observer</span></code> with its <code class="docutils literal notranslate"><span class="pre">copy()</span></code> method.</p></li>
</ul>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">lowell</span><span class="o">.</span><span class="n">compute_pressure</span><span class="p">()</span>
...
<ul class="simple">
<li><p>Computes the pressure at the observer’s current elevation,
using the International Standard Atmosphere.</p></li>
</ul>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">boston</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">city</span><span class="p">(</span><span class="s1">&#39;Boston&#39;</span><span class="p">)</span>
...
<ul class="simple">
<li><p>XEphem includes a small database of world cities.</p></li>
<li><p>Each call to <code class="docutils literal notranslate"><span class="pre">city()</span></code> returns a new <code class="docutils literal notranslate"><span class="pre">Observer</span></code>.</p></li>
<li><p>Only latitude, longitude, and elevation are set.</p></li>
</ul>
</div></blockquote>
<section id="transit-rising-and-setting">
<span id="transit-rising-setting"></span><h3>transit, rising, and setting<a class="headerlink" href="#transit-rising-and-setting" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">sitka</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Observer</span><span class="p">()</span>
...
<ul>
<li><p>Eight <code class="docutils literal notranslate"><span class="pre">Observer</span></code> methods are available
...
<li><p>Each takes a <code class="docutils literal notranslate"><span class="pre">Body</span></code> argument,
which can be any body except an <code class="docutils literal notranslate"><span class="pre">EarthSatellite</span></code>
(for which the <code class="docutils literal notranslate"><span class="pre">next_pass()</span></code> method below should be used).</p></li>
<li><p>Starting at the Observer’s <code class="docutils literal notranslate"><span class="pre">date</span></code>
they search the entire circuit of the sky
that the body was making from its previous anti-transit to the next.</p></li>
<li><p>If the search is successful, returns a <code class="docutils literal notranslate"><span class="pre">Date</span></code> value.</p></li>
<li><p>Always leaves the <code class="docutils literal notranslate"><span class="pre">Body</span></code> at its position on that date.</p></li>
<li><p>Always leaves the Observer unmodified.</p></li>
<li><p>Takes an optional <code class="docutils literal notranslate"><span class="pre">start=</span></code> argument
giving the date and time
from which the search for a rising, transit, or setting should commence.</p></li>
<li><p>We define the meridian as the line
...
whether the body crosses the horizon or not.</p></li>
<li><p>But the rising and setting functions raise exceptions
...
<li><p>Rising and setting are defined
as the moments when the upper limb of the body touches the horizon
(that is, when the body’s <code class="docutils literal notranslate"><span class="pre">alt</span></code> plus <code class="docutils literal notranslate"><span class="pre">radius</span></code> equals zero).</p></li>
<li><p>Rising and setting
...
set the <code class="docutils literal notranslate"><span class="pre">pressure</span></code> to zero to turn off refraction.</p></li>
<li><p>Rising and setting pay attention
to the observer’s <code class="docutils literal notranslate"><span class="pre">horizon</span></code> attribute;
see the next section.</p></li>
</ul>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">line1</span> <span class="o">=</span> <span class="s2">&quot;IRIDIUM 80 [+]&quot;</span>
...
<ul>
<li><p>The <code class="docutils literal notranslate"><span class="pre">next_pass()</span></code> method takes an <code class="docutils literal notranslate"><span class="pre">EarthSatellite</span></code> body
and determines when it will next cross above the horizon.</p></li>
<li><p>It returns a six-element tuple giving:</p>
...
<li><p>Any of the tuple values can be <code class="docutils literal notranslate"><span class="pre">None</span></code> if that event was not found.</p></li>
</ul>
</div></blockquote>
</section>
<section id="observer-horizon">
<h3>observer.horizon<a class="headerlink" href="#observer-horizon" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">sun</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Sun</span><span class="p">()</span>
...
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">horizon</span></code> attribute defines your <em>horizon</em>,
the altitude of the upper limb of a body
at the moment you consider it to be rising and setting.</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">horizon</span></code> defaults to zero degrees.</p></li>
<li><p>The United States Naval Observatory,
...
and define the horizon itself as being at 34’ altitude instead.</p></li>
<li><p>To determine
when a body will rise “high enough” above haze or obstacles,
set <code class="docutils literal notranslate"><span class="pre">horizon</span></code> to a positive number of degrees.</p></li>
<li><p>A negative value of <code class="docutils literal notranslate"><span class="pre">horizon</span></code> can be used
when an observer is high off of the ground.</p></li>
</ul>
</div></blockquote>
</section>
<section id="other-observer-methods">
<h3>other Observer methods<a class="headerlink" href="#other-observer-methods" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">madrid</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">city</span><span class="p">(</span><span class="s1">&#39;Madrid&#39;</span><span class="p">)</span>
...
<li><p>Computes the Local Apparent Sidereal Time (LAST)
for the observer’s latitude, longitude, date, and time.</p></li>
<li><p>The return value is a floating point angle measured in radians
that prints as hours, minutes, and seconds
where there are 24 hours in a full Earth rotation.</p></li>
</ul>
</div></blockquote>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">ra</span><span class="p">,</span> <span class="n">dec</span> <span class="o">=</span> <span class="n">madrid</span><span class="o">.</span><span class="n">radec_of</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="s1">&#39;90&#39;</span><span class="p">)</span>  <span class="c1"># altitude=90°: the zenith</span>
...
<ul class="simple">
<li><p>Both of the arguments <code class="docutils literal notranslate"><span class="pre">az</span></code> and <code class="docutils literal notranslate"><span class="pre">alt</span></code> are interpreted as angles,
using PyEphem’s usual convention:
a float point number is radians,
while a string is interpreted as degrees.</p></li>
<li><p>Returns the astrometric right ascension and declination
of the point on the celestial sphere
that lies at the apparent azimuth and altitude provided as arguments.</p></li>
<li><p>Returns J2000 star chart coordinates
...
with an assignment like <code class="docutils literal notranslate"><span class="pre">madrid.epoch</span> <span class="pre">=</span> <span class="pre">madrid.date</span></code>.</p></li>
</ul>
</div></blockquote>
</section>
</section>
<hr class="docutils" />
<section id="equinoxes-solstices">
<h2>Equinoxes &amp; Solstices<a class="headerlink" href="#equinoxes-solstices" title="Permalink to this heading"></a></h2>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d1</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">next_equinox</span><span class="p">(</span><span class="s1">&#39;2000&#39;</span><span class="p">)</span>
...
<ul>
<li><p>Functions take a <code class="docutils literal notranslate"><span class="pre">Date</span></code> argument.</p></li>
<li><p>Return a <code class="docutils literal notranslate"><span class="pre">Date</span></code>.</p></li>
<li><p>Available functions:</p>
...
<hr class="docutils" />
<section id="phases-of-the-moon">
<h2>Phases of the Moon<a class="headerlink" href="#phases-of-the-moon" title="Permalink to this heading"></a></h2>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d1</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">next_full_moon</span><span class="p">(</span><span class="s1">&#39;1984&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">d1</span><span class="p">)</span>
...
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">a</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">degrees</span><span class="p">(</span><span class="mf">3.141593</span><span class="p">)</span>  <span class="c1"># float: radians</span>
...
<ul>
<li><p>Many <code class="docutils literal notranslate"><span class="pre">Body</span></code> and <code class="docutils literal notranslate"><span class="pre">Observer</span></code> attributes
return their value as <code class="docutils literal notranslate"><span class="pre">Angle</span></code> objects.</p></li>
<li><p>Most angles are measured in degrees.</p></li>
<li><p>Only right ascension is measured in hours.</p></li>
<li><p>You can also create angles yourself through two <code class="docutils literal notranslate"><span class="pre">ephem</span></code> functions:</p>
<div class="line-block">
...
<li><p>Each angle acts like a Python <code class="docutils literal notranslate"><span class="pre">float</span></code>.</p></li>
<li><p>Angles always store floating-point radians.</p></li>
<li><p>Only when printed, passed to <code class="docutils literal notranslate"><span class="pre">str()</span></code>, or formatted with <code class="docutils literal notranslate"><span class="pre">'%s'</span></code>
do angles display themselves as degrees or hours.</p></li>
<li><p>When setting an angle attribute in a body or observer,
...
<li><p>When doing math on angles,
...
<li><p>For more details see the <a class="reference external" href="angle">Angle</a> document.</p></li>
</ul>
</div></blockquote>
</section>
<hr class="docutils" />
<section id="dates">
<h2>Dates<a class="headerlink" href="#dates" title="Permalink to this heading"></a></h2>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Date</span><span class="p">(</span><span class="s1">&#39;1997/3/9 5:13&#39;</span><span class="p">)</span>
...
<ul>
<li><p>Dates are stored and returned as floats.</p></li>
<li><p>Only when printed, passed to <code class="docutils literal notranslate"><span class="pre">str()</span></code>, or formatted with <code class="docutils literal notranslate"><span class="pre">'%s'</span></code>
does a date express itself as a string
giving the calendar day and time.</p></li>
<li><p>The modern Gregorian calendar is used for recent dates,
and the old Julian calendar for dates before October 15, 1582.</p></li>
<li><p>Dates <em>always</em> use Universal Time, <em>never</em> your local time zone.</p></li>
<li><p>Call <code class="docutils literal notranslate"><span class="pre">.triple()</span></code> to split a date into its year, month, and day.</p></li>
<li><p>Call <code class="docutils literal notranslate"><span class="pre">.tuple()</span></code> to split a date into its year, month, day,
hour, minute, and second.</p></li>
<li><p>You can create <code class="docutils literal notranslate"><span class="pre">ephem.Date()</span></code> dates yourself
in addition to those you will be returned by other objects.</p></li>
<li><p>Call <code class="docutils literal notranslate"><span class="pre">ephem.now()</span></code> for the current date and time.</p></li>
<li><p>When setting a date attribute in a body or observer,
or creating angles yourself,
...
<li><p>Dates store the number of days that have passed
...
<li><p>For more details see the <a class="reference external" href="date">Date</a> document.</p></li>
</ul>
</div></blockquote>
<section id="to-your-local-time-zone">
<h3>to your local time zone<a class="headerlink" href="#to-your-local-time-zone" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Date</span><span class="p">(</span><span class="s1">&#39;1997/3/9 5:13&#39;</span><span class="p">)</span>
...
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">localtime()</span></code> function converts a PyEphem date
into a Python <code class="docutils literal notranslate"><span class="pre">datetime</span></code> object expressed in your local time zone.</p></li>
</ul>
</div></blockquote>
</section>
<section id="to-a-specific-timezone">
<h3>to a specific timezone<a class="headerlink" href="#to-a-specific-timezone" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">zoneinfo</span> <span class="kn">import</span> <span class="n">ZoneInfo</span>
...
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">to_timezone()</span></code> function converts a PyEphem date
...
For simplicity an own implementation for UTC is provided.</p></li>
<li><p>Python 3.9 and later offer world time zones in the
...
the third-party <a class="reference external" href="https://pypi.org/project/pytz/">pytz</a> module.</p></li>
</ul>
</div></blockquote>
</section>
<section id="from-a-specific-timezone">
<h3>from a specific timezone<a class="headerlink" href="#from-a-specific-timezone" title="Permalink to this heading"></a></h3>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">datetime</span> <span class="kn">import</span> <span class="n">datetime</span>
...
<ul class="simple">
<li><p><em>New in PyEphem 4.1.1:</em>
...
then PyEphem will automatically convert the date into UTC for you.</p></li>
<li><p>Python 3.9 and later offer world time zones in the
<a class="reference external" href="https://docs.python.org/3/library/zoneinfo.html">zoneinfo</a> module.
Previous versions of Python can load world time zones by installing
the third-party <a class="reference external" href="https://pypi.org/project/pytz/">pytz</a> module.</p></li>
...
<hr class="docutils" />
<section id="stars-and-cities">
<h2>Stars and Cities<a class="headerlink" href="#stars-and-cities" title="Permalink to this heading"></a></h2>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">rigel</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">star</span><span class="p">(</span><span class="s1">&#39;Rigel&#39;</span><span class="p">)</span>
...
<ul class="simple">
<li><p>PyEphem provides a catalog of bright stars.</p></li>
<li><p>Each call to <code class="docutils literal notranslate"><span class="pre">star()</span></code> returns a new <code class="docutils literal notranslate"><span class="pre">FixedBody</span></code>
whose coordinates are those of the named star.</p></li>
</ul>
</div></blockquote>
<blockquote>
<div><div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">stuttgart</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">city</span><span class="p">(</span><span class="s1">&#39;Stuttgart&#39;</span><span class="p">)</span>
...
<ul class="simple">
<li><p>PyEphem knows 122 world cities.</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">city()</span></code> function returns an <code class="docutils literal notranslate"><span class="pre">Observer</span></code>
whose longitude, latitude, and elevation
are those of the given city.</p></li>
</ul>
</div></blockquote>
</section>
<hr class="docutils" />
...
<blockquote>
<div><ul>
<li><p>PyEphem provides constants
...
<li><p>PyEphem provides, for reference,
...
<li><p>PyEphem provides the speed of light in meters per second:</p>
...
<hr class="docutils" />
<section id="attributes-to-avoid">
<h2>Attributes to avoid<a class="headerlink" href="#attributes-to-avoid" title="Permalink to this heading"></a></h2>
<blockquote>
<div><ul class="simple">
<li><p>To avoid breaking old scripts,
...
in the “transit, rising, and setting” section.</p>
<ul>
<li><p><code class="docutils literal notranslate"><span class="pre">rise_time</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">rise_az</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">transit_time</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">transit_alt</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">set_time</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">set_az</span></code></p></li>
</ul>
</li>
</ul>
</div></blockquote>
