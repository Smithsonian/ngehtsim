...
<head>
  ...
  <title>The PyEphem Tutorial &mdash; ngehtsim 0+untagged.129.g080dfe2.dirty documentation</title>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/source/api.html">API</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../../_sources/.tox/py3/lib/python3.9/site-packages/ephem/doc/tutorial.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
  ...
  <section id="the-pyephem-tutorial">
<h1>The PyEphem Tutorial<a class="headerlink" href="#the-pyephem-tutorial" title="Permalink to this heading"></a></h1>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">u</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Uranus</span><span class="p">()</span>
...
see the <a class="reference internal" href="quick.html"><span class="doc">PyEphem Quick Reference</span></a>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">j</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Jupiter</span><span class="p">(</span><span class="s1">&#39;1612/12/28&#39;</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">def</span> <span class="nf">hpos</span><span class="p">(</span><span class="n">body</span><span class="p">):</span> <span class="k">return</span> <span class="n">body</span><span class="o">.</span><span class="n">hlon</span><span class="p">,</span> <span class="n">body</span><span class="o">.</span><span class="n">hlat</span>
...
<section id="computing-with-angles">
<h2>Computing With Angles<a class="headerlink" href="#computing-with-angles" title="Permalink to this heading"></a></h2>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">u</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Uranus</span><span class="p">(</span><span class="s1">&#39;1871/3/13&#39;</span><span class="p">)</span>
...
while a float is interpreted as radians.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">ephem</span><span class="o">.</span><span class="n">degrees</span><span class="p">(</span><span class="s1">&#39;90.0&#39;</span><span class="p">))</span>
...
<p>Note that the format operator <code class="docutils literal notranslate"><span class="pre">%</span></code> can return either value,
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">aph_angle</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">separation</span><span class="p">(</span><span class="n">hpos</span><span class="p">(</span><span class="n">ma0</span><span class="p">),</span> <span class="n">hpos</span><span class="p">(</span><span class="n">ma1</span><span class="p">))</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">aph_area</span> <span class="o">=</span> <span class="n">aph_distance</span> <span class="o">*</span> <span class="n">ma0</span><span class="o">.</span><span class="n">sun_distance</span> <span class="o">/</span> <span class="mf">2.</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">peri_angle</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">separation</span><span class="p">(</span><span class="n">hpos</span><span class="p">(</span><span class="n">mp0</span><span class="p">),</span> <span class="n">hpos</span><span class="p">(</span><span class="n">mp1</span><span class="p">))</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">deg</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">degrees</span>
...
<section id="computing-with-dates">
<h2>Computing With Dates<a class="headerlink" href="#computing-with-dates" title="Permalink to this heading"></a></h2>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Date</span><span class="p">(</span><span class="s1">&#39;1984/12/21 15:00&#39;</span><span class="p">)</span>
...
<span class="go">datetime.datetime(1984, 12, 21, 10, 0)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Date</span><span class="p">(</span><span class="s1">&#39;1950/2/28&#39;</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Date</span><span class="p">(</span><span class="mf">34530.34375</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="s1">&#39;as a float: </span><span class="si">%f</span><span class="se">\n</span><span class="s1">as a string: &quot;</span><span class="si">%s</span><span class="s1">&quot;&#39;</span> <span class="o">%</span> <span class="p">(</span><span class="n">d</span><span class="p">,</span> <span class="n">d</span><span class="p">))</span>
...
<section id="computations-for-particular-observers">
<h2>Computations for Particular Observers<a class="headerlink" href="#computations-for-particular-observers" title="Permalink to this heading"></a></h2>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">gatech</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Observer</span><span class="p">()</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">gatech</span><span class="o">.</span><span class="n">date</span> <span class="o">=</span> <span class="s1">&#39;1984/5/30 16:22:56&#39;</span>   <span class="c1"># 12:22:56 EDT</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">gatech</span><span class="o">.</span><span class="n">date</span> <span class="o">=</span> <span class="s1">&#39;1984/5/31 00:00&#39;</span>   <span class="c1"># 20:00 EDT</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">sun</span><span class="o">.</span><span class="n">compute</span><span class="p">(</span><span class="n">gatech</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">gatech</span><span class="o">.</span><span class="n">next_setting</span><span class="p">(</span><span class="n">sun</span><span class="p">))</span>
<span class="go">1984/5/31 00:42:22</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="s2">&quot;</span><span class="si">%s</span><span class="s2"> </span><span class="si">%s</span><span class="s2">&quot;</span> <span class="o">%</span> <span class="p">(</span><span class="n">sun</span><span class="o">.</span><span class="n">alt</span><span class="p">,</span> <span class="n">sun</span><span class="o">.</span><span class="n">az</span><span class="p">))</span>
<span class="go">-0:15:45.8 297:20:43.7</span>
</pre></div>
</div>
...
See the section on <a class="reference internal" href="quick.html#transit-rising-setting"><span class="std std-ref">transit, rising, and setting</span></a>
in the Quick Reference for more details.</p>
</section>
<section id="loading-bodies-from-catalogues">
<h2>Loading Bodies From Catalogues<a class="headerlink" href="#loading-bodies-from-catalogues" title="Permalink to this heading"></a></h2>
...
<a class="reference internal" href="catalogs.html"><span class="doc">Asteroid, Comet, and Satellite Catalogs</span></a> of orbital elements.
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">yh</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">readdb</span><span class="p">(</span><span class="s2">&quot;C/2002 Y1 (Juels-Holvorcem),e,103.7816,&quot;</span> <span class="o">+</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">yh</span><span class="p">)</span>  
...
see the <a class="reference internal" href="quick.html"><span class="doc">PyEphem Quick Reference</span></a> for their names and meanings.
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">iss</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">readtle</span><span class="p">(</span><span class="s2">&quot;ISS (ZARYA)&quot;</span><span class="p">,</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">gatech</span><span class="o">.</span><span class="n">date</span> <span class="o">=</span> <span class="s1">&#39;2003/3/23 8:00&#39;</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">iss</span><span class="o">.</span><span class="n">compute</span><span class="p">(</span><span class="n">gatech</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="s2">&quot;</span><span class="si">%s</span><span class="s2"> </span><span class="si">%s</span><span class="s2"> </span><span class="si">%s</span><span class="s2">&quot;</span> <span class="o">%</span> <span class="p">(</span><span class="n">iss</span><span class="o">.</span><span class="n">rise_time</span><span class="p">,</span> <span class="n">iss</span><span class="o">.</span><span class="n">transit_time</span><span class="p">,</span> <span class="n">iss</span><span class="o">.</span><span class="n">set_time</span><span class="p">))</span>
...
again, see the <a class="reference internal" href="quick.html"><span class="doc">PyEphem Quick Reference</span></a> for details.</p>
</section>
<section id="fixed-objects-precession-and-epochs">
<h2>Fixed Objects, Precession, and Epochs<a class="headerlink" href="#fixed-objects-precession-and-epochs" title="Permalink to this heading"></a></h2>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">polaris</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">readdb</span><span class="p">(</span><span class="s2">&quot;Polaris,f|M|F7,2:31:48.704,89:15:50.72,2.02,2000&quot;</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">polaris</span><span class="o">.</span><span class="n">compute</span><span class="p">()</span>    <span class="c1"># uses the current time by default</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">polaris</span><span class="o">.</span><span class="n">compute</span><span class="p">(</span><span class="n">epoch</span><span class="o">=</span><span class="s1">&#39;2100&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">polaris</span><span class="o">.</span><span class="n">a_dec</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">thuban</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">readdb</span><span class="p">(</span><span class="s2">&quot;Thuban,f|V|A0,14:4:23.3,64:22:33,3.65,2000&quot;</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">thuban</span><span class="o">.</span><span class="n">compute</span><span class="p">(</span><span class="n">epoch</span><span class="o">=</span><span class="s1">&#39;-2800&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">thuban</span><span class="o">.</span><span class="n">a_dec</span><span class="p">)</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">j</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Jupiter</span><span class="p">()</span>
...
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">j1</span><span class="p">,</span> <span class="n">j2</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Jupiter</span><span class="p">(),</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Jupiter</span><span class="p">()</span>
