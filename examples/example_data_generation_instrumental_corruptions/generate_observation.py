...
obs_thnoise.save_uvfits('./datafile_thermal_noise_only.uvfits')
obs_thgains.save_uvfits('./datafile_thermal_noise_plus_gains.uvfits')
obs_thleak.save_uvfits('./datafile_thermal_noise_plus_leakage.uvfits')
obs_full.save_uvfits('./datafile_thermal_noise_plus_gains_plus_leakage.uvfits')
...
plt.savefig('radplot_nonoise.png',dpi=300,bbox_inches='tight')
plt.close()
...
plt.savefig('radplot_thermal_noise_only.png',dpi=300,bbox_inches='tight')
plt.close()
...
plt.savefig('radplot_thermal_noise_plus_gains.png',dpi=300,bbox_inches='tight')
plt.close()
...
plt.savefig('radplot_thermal_noise_plus_leakage.png',dpi=300,bbox_inches='tight')
plt.close()
...
plt.savefig('radplot_thermal_noise_plus_gains_plus_leakage.png',dpi=300,bbox_inches='tight')
plt.close()
