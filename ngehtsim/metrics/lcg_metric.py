...
def LCG_metric(obs, method='analytic', tavg=None, scan_avg=False, dummy_circ=True, dummy_circ_res=None,
               plot_solution=False, niter=200, specify_x0=None, verbose=False):
    # input:
    ...
    # Authors: Maciek Wielgus, Daniel Palumbo, Linus Hamilton 2020

    start0 = time.time()
    if tavg:
        obs = obs.avg_coherent(inttime=tavg, scan_avg=scan_avg)
