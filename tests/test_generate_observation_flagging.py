...
# input settings file
yamlfile = './tests/data_generation_flagging/settings.yaml'
...
obs.save_uvfits('./tests/data_generation_flagging/example_datafile.uvfits')
...
plt.savefig('./tests/data_generation_flagging/uv-coverage.png',dpi=300,bbox_inches='tight')
plt.close()
