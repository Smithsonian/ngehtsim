...
# input settings file
yamlfile = './tests/data_generation_with_FPT/settings_fpt.yaml'
...
# input settings file
yamlfile = './tests/data_generation_with_FPT/settings_no_fpt.yaml'
...
# save it as a uvfits file
obs.save_uvfits('./tests/data_generation_with_FPT/example_datafile_no_fpt.uvfits')
...
plt.savefig('./tests/data_generation_with_FPT/uv-coverage.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('./tests/data_generation_with_FPT/radplot.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('./tests/data_generation_with_FPT/data_histogram.png', dpi=300, bbox_inches='tight')
plt.close()
