...
op.plot_uv(obs, filename='./tests/example_plot_uv.png')
op.plot_amp(obs, filename='./tests/example_plot_amp.png')
op.plot_phase(obs, filename='./tests/example_plot_phase.png')
op.plot_snr(obs, filename='./tests/example_plot_snr.png')
...
op.plot_snapshot(obs, obsgen, 'FF', fov=200.0, filename='./tests/example_plot_FF.png')
